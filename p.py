...
####try 3
cnn3 = Sequential()
cnn3.add(Conv2D(32, kernel_size=(3, 3), activation='relu', input_shape=(500,500,3)))
...
'''
cnn3.save_weights('cnn3_epochs.h5')
pred_bool = (pred >0.5)
